...
export const API = {
    crt: {
        ...
        wcslen          : new NativeFunction(Modules.ucrtbase.getExportByName('wcslen'), 'uint32', ['pointer'], 'mscdecl'),
        wcscat_s        : new NativeFunction(Modules.ucrtbase.getExportByName('wcscat_s'), 'uint32', ['pointer', 'size_t', 'pointer'], 'mscdecl'),
    },
